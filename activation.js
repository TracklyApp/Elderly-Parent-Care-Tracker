...
window.KindredActivation=(function(){
 ...
 function install(){
  ...
  render=function(){activeProfileId=KindredExamples.id;previousRender();const picker=document.querySelector('#profilePicker');picker.innerHTML='<option value="kindred-demo-profile">Demo - Eleanor Brooks (20 records total)</option><option value="activate">Activate my care space...</option>';document.querySelector('#syncStatus').textContent='Demo - no personal records saved';};
